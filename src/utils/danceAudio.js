...
export const danceAudio = (audio,canvas,url)=>{

    // let audio,
    let audioContext, audioSrc;
    let analyser, analyserBufferLength;
    let audioInfo = 'Song: LAKEY INSPIRED - Chill Day';
...
//---
    ...
    function getRGBColor() {
      ...
      let r = Math.sin( rgb.r += 0.010 ) * 1 + 1;
      let g = Math.sin( rgb.g += 0.007 ) * 1 + 1;
      let b = Math.sin( rgb.b += 0.013 ) * 1 + 1;
      //let r = Math.sin( rgb.r += 0.040 ) * 1 + 1;
      //let g = Math.sin( rgb.g += 0.028 ) * 1 + 1;
      //let b = Math.sin( rgb.b += 0.052 ) * 1 + 1;
    ...
    function getRGBColor( color ) {
        ...
        let r = Math.sin( color.r += 0.010 ) * 1 + 1;
        let g = Math.sin( color.g += 0.007 ) * 1 + 1;
        let b = Math.sin( color.b += 0.013 ) * 1 + 1;
        //let r = Math.sin( color.r += 0.040 ) * 1 + 1;
        //let g = Math.sin( color.g += 0.028 ) * 1 + 1;
        //let b = Math.sin( color.b += 0.052 ) * 1 + 1;
...
//---
    ...
    function drawCircle( centerPosition, radius, segments ) {
        ...
        for ( let i = 0; i <= segments; i++ ) {
            ...
            //let radiusRandom = radius + Math.random() * ( radius / 32 );
            let radiusRandom = radius;// + ( radius / 8 );
    ...
    function render() {
        ...
        for ( let i = 0, l = circleHolder.length; i < l; i++ ) {
            ...
            if ( aa === true ) {
                ...
                //let f = frequencySource[ Math.floor(circleObj.z + fov) ];
                //let f = frequencySource[ i ];
                //let f = frequencySource[ circleObj.audioIndex ];
                //let fAdd = (f / 25);// * ( (circleObj.z - fov) / 200 );
            ...
            for ( let j = 0, k = circleObj.segmentsOutside.length; j < k; j++ ) {
                ...
                if ( circleSegmentOutside.active === true ) {
                    ...
                    /*} else {
                      ...
                      let circleSegmentOutside1 = circleObj.segmentsOutside[ 0 ];
                  ...
                  //if ( i > 0 && i < l - 1 && j < k - 1 ) {
                    ...
                    let circleSegmentOutsideLineBack;// = circleObjBack[ j ];
                    let circleSegmentInsideLineBack;
